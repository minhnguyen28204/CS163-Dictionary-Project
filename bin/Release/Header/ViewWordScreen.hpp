...
private:
    ...
    sf::Sprite object, saveSprite, cancelSprite, deleteSprite;
    sf::Texture objTexture, saveObj, cancelObj, deleteObj;
    sf::RectangleShape editBound, saveBound, cancelBound, addBound, deleteBound;
    sf::Text KeyWord;
    sf::Text TestDef;
    sf::Text addText;
    sf::Font _font;
