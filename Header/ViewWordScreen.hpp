...
private:
    ...
    sf::Sprite object, saveSprite, cancelSprite, deleteSprite, tickSprite;
    sf::Texture objTexture, saveObj, cancelObj, deleteObj, tickObj;
    sf::RectangleShape editBound, saveBound, cancelBound, addBound, deleteBound, tickBound;
    sf::Text KeyWord;
    sf::Text TestDef;
    sf::Text addText;
